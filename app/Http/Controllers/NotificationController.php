...
class NotificationController extends Controller
{
    ...
    //     if (!$notification) {
    //         return response()->json(['message' => 'Notification not found or you do not have permission to read it.'], 404);
    //     }
    ...
    //     if (!$notification) {
    //         return response()->json(['message' => 'Notification not found or you do not have permission to delete it.'], 404);
    //     }
